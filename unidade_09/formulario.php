            ...
            function alterarFormulario(dados) {
                $.ajax({
                    ...
                    if (sucesso) {
                        ...
                        //Esta falha acontece quando a página consegue se comunicar com o banco mais por algum motivo não consegue fazer a alteração
                        $('#mensagem p').html(mensagem);
                    }
                }).fail(function(){
                    //Agora esta falha acontece quando a página nem consegue se comunicar com o banco de dados
